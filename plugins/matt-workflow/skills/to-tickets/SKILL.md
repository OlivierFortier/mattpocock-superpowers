...
The issue tracker and triage label vocabulary should have been provided to you — run `[$matt-workflow:setup-matt-pocock-skills](../setup-matt-pocock-skills/SKILL.md)` if not.
...
Publish the approved tickets. **How** depends on the tracker `[$matt-workflow:setup-matt-pocock-skills](../setup-matt-pocock-skills/SKILL.md)` configured — the tickets are the same either way, only the shape of the blocking edges changes:
