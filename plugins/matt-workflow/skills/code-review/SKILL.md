...
The issue tracker should have been provided to you — run `[$matt-workflow:setup-matt-pocock-skills](../setup-matt-pocock-skills/SKILL.md)` if `docs/agents/issue-tracker.md` is missing.
